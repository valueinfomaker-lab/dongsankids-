...
const morningSchedule: ScheduleItem[] = [
  ...
  { time: "09:30", label: "자유놀이", icon: "🎮", desc: "실내 자유선택 활동", photo: "/images/programs/play-1.jpg" },
  { time: "10:30", label: "이야기 나누기", icon: "💬", desc: "주제 탐구, 언어·수학 활동", photo: "/images/programs/reading-1.jpg" },
  { time: "11:30", label: "바깥 활동", icon: "🌳", desc: "실외놀이, 텃밭, 산책", photo: "/images/programs/eco-1.jpg" },
...
const afternoonSchedule: ScheduleItem[] = [
  ...
  { time: "14:30", label: "오후 활동", icon: "🎨", desc: "특성화 교육, 프로젝트 활동", photo: "/images/programs/art-1.jpg" },
